...
function Tile({
  ...
  return (
    <div className="hero-tile" data-tile={id}>
      ...
      <img className="tile-img" src={src} alt={alt} />
    </div>
  );
}
...
function RailTile({
  ...
  return (
    <div className={`tile ${aspect === "wide" ? "wide" : ""}`}>
      {/* eslint-disable-next-line @next/next/no-img-element */}
      <img className="tile-img" src={src} alt={alt} loading="lazy" />
    </div>
  );
}
...
function Hero() {
  return (
    <section className="hero">
      ...
      <Tile id="1" src="/img/skyline-sunset.jpg" alt="city skyline at sunset" />
      <Tile id="2" src="/img/skyline-blue.jpg" alt="city skyline under clouds" />
      <Tile id="3" src="/img/fort-boulders.jpg" alt="hilltop fort among boulders" />
      <Tile id="4" src="/img/bean.jpg" alt="cloud gate reflecting the skyline" />
    </section>
  );
}
    ...
    <div id="about" className="body-wrap">
      <aside className="sidebar">
        <div className="portrait">
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img className="tile-img" src="/img/me.jpg" alt="Manish K Reddy" />
        </div>
        <h1>
      ...
      <aside className="right-rail">
        <RailTile src="/img/cathedral.jpg" alt="cathedral tower at dusk" />
        <RailTile src="/img/skyline-dusk.jpg" alt="city skyline at dusk" aspect="wide" />
        <RailTile src="/img/union-station.jpg" alt="union station great hall" />
        <RailTile src="/img/park-blossom.jpg" alt="spring blossoms in the park" />
      </aside>
    </div>
  );
}
...
function Research() {
  return (
    <div id="research" className="body-wrap">
      ...
      <aside className="right-rail">
        <RailTile src="/img/glass-tower.jpg" alt="glass tower against the sky" />
        <RailTile src="/img/fort-pond.jpg" alt="hilltop fort and stepwell pond" aspect="wide" />
        <RailTile src="/img/mural.jpg" alt="large building mural" />
        <RailTile src="/img/fort-sky.jpg" alt="fort under an open sky" aspect="wide" />
        <RailTile src="/img/domed-tower.jpg" alt="ornate domed tower" />
      </aside>
    </div>
  );
}
...
function Experience() {
  return (
    <div id="experience" className="body-wrap">
      ...
      <aside className="right-rail">
        <RailTile src="/img/tower-blue.jpg" alt="skyscraper against blue sky" />
        <RailTile src="/img/fort-temple.jpg" alt="stone temple within the fort" aspect="wide" />
        <RailTile src="/img/traveling-man.jpg" alt="traveling man sculpture at night" />
        <RailTile src="/img/fort-hill.jpg" alt="boulder-strewn fort hill" aspect="wide" />
      </aside>
    </div>
  );
}
